-- Uma remessa cancelada deixa de compor o atendimento. Itens que estavam
-- exclusivamente em trânsito voltam a ficar disponíveis para nova expedição.
...
revoke all on function public.recalcular_situacao_pedido_por_remessas(text) from public;
grant execute on function public.recalcular_situacao_pedido_por_remessas(text) to authenticated;
