-- A filial destinatária confirma normalmente; o CD pode registrar a confirmação
-- em seu nome quando necessário, sem permitir acesso a outros usuários.
...
begin
  ...
  if public.meu_papel() <> 'cd_admin'
     and (public.meu_papel() <> 'filial' or v_filial_id <> public.minha_filial_id()) then
    raise exception 'Somente o administrador do CD ou a filial destinatária pode confirmar esta remessa.';
  end if;
